 ...
 * @version $Id$
 */
@Named("instance/accept")
public class ReplicationInstanceAcceptEndpoint extends AbstractReplicationEndpoint
{
        ...
        throws Exception
    {
        ...
        this.instances.confirmRequestedInstance(new DefaultReplicationInstance(name, id, uri));
    }
}
