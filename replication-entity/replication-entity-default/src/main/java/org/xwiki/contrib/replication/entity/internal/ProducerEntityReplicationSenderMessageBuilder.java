 ...
 * @since 2.0.0
 */
public class ProducerEntityReplicationSenderMessageBuilder extends AbstractEntityReplicationSenderMessageBuilder
{
    private final EntityReplicationSenderMessageBuilderProducer<EntityReplicationSenderMessageBuilder> messageProducer;

    /**
     * @param messageProducer produce the message
     * @param entityReference the reference of the entity associated with the message
     */
    public ProducerEntityReplicationSenderMessageBuilder(
    ...
    {
        return this.messageProducer.produce(this, level, readonly, metadata);
    }
}
