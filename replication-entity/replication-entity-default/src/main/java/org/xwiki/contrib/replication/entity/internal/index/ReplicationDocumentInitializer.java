 ...
 */
@Component
@Named("ReplicationDocumentInitializer")
@Singleton
public class ReplicationDocumentInitializer extends AbstractEventListener
{
    @Inject
     ...
     * Setup the listener.
     */
    public ReplicationDocumentInitializer()
    {
        super("ReplicationDocumentInitializer", new ApplicationStartedEvent());
    }
